...
def attendance(request):
    my_models = Attendance.objects.all()
    data = [{'number': model.number, 'full_name': model.full_name, 'card_id': model.card_id, 'time_in': model.time_in,'time_out': model.time_out, 'card_id': model.card_id, 'is_staff': model.is_staff} for model in my_models]
...
def submit_attendance(request):
    if request.method == 'POST':
        ...
        def main():
            encodingsdb_student_folder = r'C:\Users\kal\Desktop\updated\school_security_system\media\encodingsdb\student'
            encodingsdb_staff_folder = r'C:\Users\kal\Desktop\updated\school_security_system\media\encodingsdb\staff'
                ...
                try:
                    ...
                    if match_filename:
                        if is_staff:
                            ...
                            try:
                                student = get_object_or_404(Student, card_id=match_filename)
